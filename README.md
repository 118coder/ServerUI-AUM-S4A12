...
[AGPL v3.0] [.NET 10.0] [Windows 10/11] [v1.81]
...
```
ServerS4A12-管理工具包-v1.81/
├── 开始游戏-ServerUI.exe          # 依赖版入口 (376KB)
├── 本地游戏S4.bat                  # 游戏启动脚本
├── 项目状态快照-v1.81.md           # 完整技术文档
├── AUM管理组件\                    # 核心组件目录
...
1. 解压 `ServerS4A12-管理工具包-v1.81.zip` 到游戏主目录
...
| 版本 | 大小 | 说明 |
|------|------|------|
| 管理工具包 v1.81 | ~359MB | 完整分发包（含源码 + 双版本 EXE） |
